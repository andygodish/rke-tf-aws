  ...
  content = templatefile("${path.module}/templates/rke_inventory.tpl",
    {
      ...
      worker_node_public_dns  = aws_instance.k8s_agent_node.*.public_dns,
      worker_node_public_ip   = aws_instance.k8s_agent_node.*.public_ip,
      worker_node_private_ip  = aws_instance.k8s_agent_node.*.private_ip,
